...
public class LocationCreate {
    ...
    public void locationSelect() {
        ...
        System.out.print("""
                ...
                """);
        int locationInput = locationInputChecker.nextInt();
        ...
        while (!locationValidInput) {
            switch (locationInput) {
                ...
                default -> System.out.print("Я понимаю, список большой, но всё же, повторяю по-русски ещё раз: выбери из имеющихся.");
            }
        }
    }
}
